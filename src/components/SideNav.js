  ...
  return (
    <div class="navContainer">
      <img class="portrait" src="../asset/portrait.png"/>
        <p class="description">
          Jacob is a Web Developer out of Seattle WA. When he isn't programming the internet of things, he is drawing, teaching, reviewing movies, and doing video game things.
        </p>
