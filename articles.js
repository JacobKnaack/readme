/*
  ...
  CLASSES: p-subtitle => subtitle for article, should ounly be one at top of article,
           ...
           code-codeBlock prettyprint linenums => code block that is styled with prettyprint with added linenums
*/
    ...
    "created_on": "Feb 6, 2018",
      "name": "Building a Chat UI with basic HTML, CSS, and Javascript: Part 2",
        "description": "A continuation from part 1, focusing on simple user interaction and updating the browser screen with easy to understand commands.",
          "html": "<p class='subtitle'>Now we will add some simple user interaction to help the user converse with the users of our Chat application, with very simple web publishing files and some javacript to help script our interacterions</p>\
                  <p>With our template and styling taking shape, let\'s added some functions to get our users interacting with our User Interface in a way that makes sense. We are going to focus on a couple things to get our functionality up and running:</p>\
                  <ul class='articleList'>\
                  <li>Functions for clicking on names in the conversation list and selecting a conversations.</li>\
                  </ul>"
  }
];
